...
export default function Header() {
    ...
    return (
        <View className="bg-white pt-[60px] pb-4 px-4 shadow-sm flex-row justify-between items-center z-50 border-b border-border">
            {/* Search Modal */}
            <SearchModal visible={isSearchVisible} onClose={() => setIsSearchVisible(false)} />
  ...
  <View className="flex-col items-end justify-center space-y-1 pt-1">
    <Text
      className="text-[22px] text-gray-900 leading-none"
      style={{ fontFamily: 'MontserratArabic_Bold' }}
    >
 طبيب
    </Text>
